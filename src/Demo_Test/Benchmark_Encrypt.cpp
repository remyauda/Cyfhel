...
int main(int argc, char *argv[])
{
	...
	{
		std::cout <<"******Homeomorphic encryption "<< k+1 <<"******"<<endl<<endl;
	...
	LibMatrix::writeDoubleInFileWithEraseData("Result_Benchmark_Encrypt", averageOfExecutionTime);// Write the double averageOfExecutionTime in the file Result_Benchmark_Encrypt in the directory ResultOfBenchmark.

	LibMatrix::writeStringInFileWithEraseData("ResultVerbose_Benchmark_Encrypt", LibMatrix::transformSecondToYearMonthWeekHourMinSecMilli(averageOfExecutionTime));// Write the string verbose to transform the average of execution time in seconds to string verbose Years, Months, Weeks, Hours, Minutes, Seconds, Milliseconds in the file ResultVerbose_Benchmark_Encrypt in the directory ResultOfBenchmark.
