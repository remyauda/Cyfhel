...
int main(int argc, char *argv[])
{
    ...
    std::cout <<"" <<endl;
    std::cout <<"     ************Benchmark_MinusEqual************" <<endl;
    std::cout <<"" <<endl;
    ...
    LibMatrix::writeDoubleInFileWithEraseData("Result_Benchmark_MinusEqual", averageOfExecutionTime);// Write the double averageOfExecutionTime in the file Result_Benchmark_MinusEqual in the directory ResultOfBenchmark.

    LibMatrix::writeStringInFileWithEraseData("ResultVerbose_Benchmark_MinusEqual", LibMatrix::transformSecondToYearMonthWeekHourMinSecMilli(averageOfExecutionTime));// Write the string verbose to transform the average of execution time in seconds to string verbose Years, Months, Weeks, Hours, Minutes, Seconds, Milliseconds in the file ResultVerbose_Benchmark_MinusEqual in the directory ResultOfBenchmark.

    // Skip a line.
    std::cout <<"\n"<<endl;

    // Display the end of the program.
    std::cout <<"     ************End of Benchmark_MinusEqual************" <<endl;
