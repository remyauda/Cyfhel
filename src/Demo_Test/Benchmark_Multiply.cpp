...
int main(int argc, char *argv[])
{
    ...
    std::cout <<"" <<endl;
    std::cout <<"     ************Benchmark_Multiply************" <<endl;
    std::cout <<"" <<endl;
    ...
    for(int k=0; k<NB_BENCHMARK; k++)
    {
    	...
    	//Perform * operation
    	// Multiply of the two cypher text.
        CyCtxt cMultiply1_2 = c1 * c2;
    ...
    LibMatrix::writeDoubleInFileWithEraseData("Result_Benchmark_Multiply", averageOfExecutionTime);// Write the double averageOfExecutionTime in the file Result_Benchmark_Multiply in the directory ResultOfBenchmark.

    LibMatrix::writeStringInFileWithEraseData("ResultVerbose_Benchmark_Multiply", LibMatrix::transformSecondToYearMonthWeekHourMinSecMilli(averageOfExecutionTime));// Write the string verbose to transform the average of execution time in seconds to string verbose Years, Months, Weeks, Hours, Minutes, Seconds, Milliseconds in the file ResultVerbose_Benchmark_Multiply in the directory ResultOfBenchmark.
    ...
    std::cout <<"     ************End of Benchmark_Multiply************" <<endl;
