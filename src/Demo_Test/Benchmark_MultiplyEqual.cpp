...
int main(int argc, char *argv[])
{
	...
	LibMatrix::writeDoubleInFileWithEraseData("Result_Benchmark_MultiplyEqual", averageOfExecutionTime);// Write the double averageOfExecutionTime in the file Result_Benchmark_MultiplyEqual in the directory ResultOfBenchmark.

	LibMatrix::writeStringInFileWithEraseData("ResultVerbose_Benchmark_MultiplyEqual", LibMatrix::transformSecondToYearMonthWeekHourMinSecMilli(averageOfExecutionTime));// Write the string verbose to transform the average of execution time in seconds to string verbose Years, Months, Weeks, Hours, Minutes, Seconds, Milliseconds in the file ResultVerbose_Benchmark_MultiplyEqual in the directory ResultOfBenchmark.
