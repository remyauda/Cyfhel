...
int main(int argc, char *argv[])
{
    ...
    {
        std::cout <<"******Perform Square operation "<< k+1 <<"******"<<endl<<endl;
    ...
    LibMatrix::writeDoubleInFileWithEraseData("Result_Benchmark_Square", averageOfExecutionTime);// Write the double averageOfExecutionTime in the file Result_Benchmark_Square in the directory ResultOfBenchmark.

    LibMatrix::writeStringInFileWithEraseData("ResultVerbose_Benchmark_Square", LibMatrix::transformSecondToYearMonthWeekHourMinSecMilli(averageOfExecutionTime));// Write the string verbose to transform the average of execution time in seconds to string verbose Years, Months, Weeks, Hours, Minutes, Seconds, Milliseconds in the file ResultVerbose_Benchmark_Square in the directory ResultOfBenchmark.
